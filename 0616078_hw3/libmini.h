...
typedef struct jmp_buf_s {
    long long reg[8];   /* RBX, RSP, RBP, R12, R13, R14, R15, return address (to the caller of setjmp) */
    sigset_t mask;
} jmp_buf[1];
...
long sys_rt_sigaction(int sig, const struct kernel_sigaction *kact, struct kernel_sigaction *koact, size_t sigsetsize);
